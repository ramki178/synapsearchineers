...
function plusSlides(prevnext){
    //alert(prevnext);
    var n = document.getElementsByClassName("project5-images");
    console.log("prevnext:" + prevnext);
    console.log("No of images: "+n.length);
    console.log("color :"+document.getElementsByClassName("project5-images")[0].style.display);
    var present_image_class=null
    for(var i=0;i<n.length ; i++){
        if(document.getElementsByClassName("project5-images")[i].style.display=='block'){
            console.log("i of image where style is none :"+document.getElementsByClassName("project5-images")[i].id);
            var text = document.getElementsByClassName("project5-images")[i].id;
            ...
            if(prevnext>0){
                if(x==(1+i)){
                    ...
                    if(x==n.length){
                        document.getElementsByClassName("project5-images-image"+x)[0].style.display='none';
                        document.getElementsByClassName("project5-images-text"+x)[0].style.display='none';
                        ...
                        document.getElementsByClassName("project5-images-image"+(i+1))[0].style.display='none';
                        document.getElementsByClassName("project5-images-text"+(i+1))[0].style.display='none';
                        document.getElementsByClassName("project5-images-image"+(i+2))[0].style.display='block';
                        document.getElementsByClassName("project5-images-text"+(i+2))[0].style.display='block';
                    }
                    return;
                }
            }   
                ...
                console.log("showing prev image");
                    ...
                    if(x==1){
                        ...
                        */
                        ...
                        document.getElementsByClassName("project5-images-image"+(x))[0].style.display='none';
                        document.getElementsByClassName("project5-images-text"+(x))[0].style.display='none';
                        document.getElementsByClassName("project5-images-image"+(x-1))[0].style.display='block';
                        document.getElementsByClassName("project5-images-text"+(x-1))[0].style.display='block';
                    }
                    return;
